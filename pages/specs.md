...
此格式的视频是 nHD 的分辨率，是 1080p 的 1/9 大小，720p 的 1/4 大小，属于标准分辨率（大陆俗称标清）。

平均每小时 270MB 的视频，建议在 2M 以上带宽下观看。
...
| **参数名称** | **对应值** |
| 格式 | High Efficiency Video Coding (HEVC/H.265) |
| 分辨率 | 1280x720 |
| 比特率模式 | 动态 |
| 平均比特率 | 1200kbps |
| 帧速率 | 29.97fps/23.976fps |
