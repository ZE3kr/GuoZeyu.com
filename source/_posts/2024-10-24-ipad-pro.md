...
3. 我还可以通过蜂窝网络备份 Lightroom 照片。使用 USB 3，我可以将所有照片导入 iPad，然后通过 5G 上传到 Lightroom。然后我 Jump 到 Mac mini 上，这些照片已经在 Mac mini 的 Lightroom 中了。Jump 到 Mac 后，我可以做 AI 去噪等处理。完成 AI 去噪后，我可以返回 iPad 的 Lightroom 进行更多操作。
