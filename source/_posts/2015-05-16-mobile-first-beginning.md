...
![简化版本的移动网页](/images/2015/mobile-first-1.png)
...
![百度新闻 iPhone 版](/images/2015/mobile-first-3.png)
...
![没有针对移动而优化的 Wikipedia 导航页](/images/2015/mobile-first-4.png)

然而通过增加的 CSS 样式表（当然还包括 `head` 中的 `viewport`），这个页面在手机上就会完美的显示了，就像下图: 

![针对移动优化了的 Wikipedia 导航页](/images/2015/mobile-first-5.png)
