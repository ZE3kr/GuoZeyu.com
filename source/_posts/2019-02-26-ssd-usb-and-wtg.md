...
3.0cm \* 2.7cm \* 0.4cm](/images/2019/ssd-1.jpg)
...
![接口协议对比图（来自 thunderbolttechnology.net）](/images/2019/ssd-2.png)
...
![从左到右依次为 iPhone XS、HP P800 Thunderbolt3 SSD、CHIPFANCIER USB3.1 Gen2 Type-C SSD](/images/2019/ZE3_0784_web.jpg)
...
![在 MacBook Pro 上，即使一个接口安装上了 CHIPFANCIER 的 SSD U盘，其旁边的接口仍然有空间连接其他 Type-C 设备。](/images/2019/ssd-7.jpg)
...
![BootCamp 下载 Windows 支持软件截图](/images/2019/ssd-5.png)
...
![绿联 Type-C 转 Type-A](/images/2019/ssd-8.jpg)
