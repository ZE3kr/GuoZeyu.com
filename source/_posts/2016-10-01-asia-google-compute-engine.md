...
![SSH 配置截图](/images/2016/gce-3.png)
...
![我所启用的所有规则列表](/images/2016/gce-4.png)

![SNMP 监控配置](/images/2016/gce-5.png)

我只需要另一个主机去访问 SNMP 监控，不需要将其公开到互联网上，所以限制了 IP。 

![用做权威 DNS 服务器的配置](/images/2016/gce-6.png)

有的 DNS 请求是通过 TCP 发送的，所以需要同样启用 TCP 请求。 如果配置了目标标记，那么就不是默认应用到所有实例的防火墙规则，还需要在实例上配置好同样的标记才可以。

![添加上相同的标记](/images/2016/gce-7.png)
