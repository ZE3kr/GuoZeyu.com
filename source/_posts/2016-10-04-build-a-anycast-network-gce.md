...
![预留 IPv6 地址的截图](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/52580111-68c9-4b63-a007-49b707f16100/large)
...
![为 Anycast 建立的两个实例](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/0353378c-82b5-44eb-fdcd-05cafc50c800/large)
...
![实例组配置页面](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/4c590a68-e98a-450d-392c-85958e7c1500/large)
...
![三种负载均衡模式](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/6574fd57-514c-4319-1550-c8c1bf83a000/large)

在负载均衡的配置界面，把这两个实例组都添加到 “后端” 中。 该功能还需要创建一个运行状态检查（相当于监控功能），当主机宕机后能实现切换。

![暂时先不开启 CDN 功能](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/8dcf1a51-670a-4292-feb8-6d87e7e26000/large)

![保留默认的 “主机路径和规则”](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/75e45756-92ae-422c-0d69-8df497efa600/large)

![目前是需要 HTTP 的例子，如果需要 HTTPS，还需要指定一个证书。](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/3390be79-2e20-4a09-2506-c4fe0cea8d00/large)

创建成功后，可以看到如下界面，其中的 IP 地址就是 Anycast IP 了。

![成功创建了一个 Anycast IP](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/8b9fc433-8d84-4b7c-c3de-6f443e763300/large)
...
![对 Anycast IP 的国外速度测试](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/44b63586-f953-451d-8549-1ffa3295d400/large)

中国的速度那更是一流的快，Google 有香港的边缘节点，所以基本上是直接走的香港节点，比原本的连接台湾可用区快不少。（只有部分 IP 段是完全直连的）

![对 Anycast IP 的国内速度测试](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/1ffc3042-5f7f-41e2-816f-87cd4a9b3100/large)

### HTTP GET 测试

在开启 CDN 功能之前，负载均衡器是不会对任何内容缓存的，所以会发现 Connect 的速度很快，但是 TTFB 延迟还是有不少。

![对 Anycast IP 进行 HTTP GET 测试](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/43b7f72f-09f1-4c65-72ae-58c640921c00/large)
...
![开启 CDN 后进行 HTTP GET 测试](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/17c182ca-f880-487e-e1fb-74a01d63ed00/large)
...
![缓存服务器的位置](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/4dcd6c19-bcaa-4d1a-2b5f-db00454a7c00/large)
...
![图形还是很漂亮的](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/e67b48a2-54bc-4950-c44d-187de69d2b00/large)

### 延迟日志

在网页后台的 Stackdriver，Trace 下，可以看到延迟日志： 

![延迟日志截图 1](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/4f9e9e5f-fea7-4d71-2a56-224606de8600/large)

![延迟日志截图 2](https://cdn.ze3kr.com/6T-behmofKYLsxlrK0l_MQ/0386e758-48cd-48fa-3b25-124a520f5700/large)
